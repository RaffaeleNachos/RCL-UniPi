...
public class MainClass {
	...
	public static void positiveResponse(String filename, OutputStream out, String ext, long dimension) {
		try {
			...
			in.close();
			*/
			//Alcuni browser non si aspettano audio e video inviati secondo HTTP/TCP quindi il server cattura una
			//SocketException Broken Pipe causata dal client (browser) che chiude la sua pipe in lettura.
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
