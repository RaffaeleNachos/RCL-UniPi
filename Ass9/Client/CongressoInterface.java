...
public interface CongressoInterface extends Remote{
	...
	// REQUIRES: name != null && giorno < 3 && giorno >= 0 && session >= 0 && session < 12
	// THROWS: 	se name = null lancia NullPointerException
	//			nel caso di problemi con RMI, lancia RemoteException
	//			se giorno < 0 || giorno >= 3 || session < 0 || session >= 12 lancia InvalidParameterException
	// MODIFIES: this
	...
	// REQUIRES: day < 3 && day >= 0
	// THROWS: 	nel caso di problemi con RMI, lancia RemoteException
	//			day >= 3 && day < 0 lancia una InvalidParameterException
	// MODIFIES: - 
	// EFFECTS: - 
